...
const About = () => {
  return (
    <div className="">
      ...
      <div className=" mt-20 sm:mt-0 bg-offWhite sm:h-[500px]">
        <div className="flex flex-col sm:flex-row-reverse justify-center items-center h-full my-auto">
          <div className="bg-[#D4DCD3] text-darkGreen text-center flex flex-col justify-center items-center flex-1 sm:h-full">
            <div className="text-5xl text-center  font-bold mt-4 md:mt-0">
              Mission
            </div>
            <div className="text-center text-md max-w-[80%] mt-4 leading-relaxed mb-4">
              At WasteWise, we are committed to revolutionizing waste management
              through innovative solutions that promote efficient waste sorting,
              recycling, and sustainable practices. Our platform connects
              individuals and communities, making it easier to manage waste
          ...
          <div className="flex-1 h-[500px] w-full flex items-center justify-center  ">
            <img
      ...
      <div className="flex flex-col sm:flex-row justify-center items-center  sm:h-[500px] ">
        <div className="bg-offWhite text-darkGreen text-center flex flex-col justify-center items-center flex-1 h-full">
          <div className="text-5xl text-center  font-bold mt-16 md:mt-0">
            Vision
          </div>
          <div className="text-center text-md max-w-[80%] mt-4 leading-relaxed mb-10">
        ...
        <div className="flex-1 h-[500px] flex items-center justify-center  sm:mt-0 ">
          <img
